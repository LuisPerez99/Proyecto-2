...
headers.append('Access-Control-Allow-Origin', 'http://34.69.253.122:5000');
...
function iniciarSesion() {
    ...
    fetch('http://34.69.253.122:5000/login', {
        method: 'POST',
        headers: headers,
        body: `{
    	        "usuario":"${user}",
        ...
        .then(usuario => {
            ...
            if (usuario == "paciente") {
                ...
                console.log(user)
                console.log(usuario)
                window.location.replace("http://34.69.253.122:5000/paciente");
            }
            ...
            if (usuario == "doctor") {
                ...
                console.log(user)
                console.log(usuario)
                window.location.replace("http://34.69.253.122:5000/doctor");
            }
            ...
            if (usuario == "enfermero") {
                ...
                console.log(user)
                console.log(usuario)
                window.location.replace("http://34.69.253.122:5000/enfermero");
            }
            ...
            if (usuario == "administrador") {
                ...
                console.log(user)
                console.log(usuario)
                window.location.replace("http://34.69.253.122:5000/admin");
            }
...
function cargarDatos() {
    ...
    let paciente = 'http://34.69.253.122:5000/paciente';
    let doctor = 'http://34.69.253.122:5000/doctor';
    let enfermero = 'http://34.69.253.122:5000/enfermero';
    let admin = 'http://34.69.253.122:5000/admin';
    ...
    if (tipoDeUsuario == 'paciente') {      
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                let direccion = 'http://34.69.253.122:5000/datos-pacientes/eliminarpaciente'
                console.log(usuario)
        ...
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                let direccion = 'http://34.69.253.122:5000/datos-enfermeras/eliminarenfermera'
                console.log(usuario)
                eliminacion(direccion, usuario)
                }
            }
        ...
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                let direccion = 'http://34.69.253.122:5000/datos-doctores/eliminardoctor'
                console.log(usuario)
                eliminacion(direccion, usuario)
                }
            }
        ...
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                let direccion = 'http://34.69.253.122:5000/datos-medicamentos/eliminarmedicamento'
                console.log(usuario)
                eliminacion(direccion, usuario)
                }
            }
    ...
    if (tipo == 'paciente') {
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                console.log(usuario)
                window.location.replace('http://34.69.253.122:5000/ver-datos')                
                }
            }
        } 
        ...
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                localStorage.setItem('tipo', tipo)
                console.log(usuario)
                window.location.replace('http://34.69.253.122:5000/ver-medicamento')                
                }
            }
        }
    }
...
function mostrarDatos() {
    ...
    if (tipo == 'paciente' || tipo == 'enfermera') {
        ...
        fetch ('http://34.69.253.122:5000/ver-medicamento', {
            method: 'POST',
            headers: headers,
            body: `{
                "nombre": "${user}"
...
function enviarInfoUsuario(tipo) {
    if (tipo == 'administrador') {
        ...
        localStorage.setItem('tipo', tipo)
        console.log(usuario)
        window.location.replace('http://34.69.253.122:5000/modificarperfil')
    ...
    if (tipo == 'paciente') {
        ...
        for (let i = 0; i < tabla.rows.length; i++) {
            for (let j = 0; j < tabla.rows[i].cells.length; j++) {
                ...
                localStorage.setItem('tipo', tipo)
                console.log(usuario)
                window.location.replace('http://34.69.253.122:5000/modificar-medicamento')                
                }
            }
        } 
    }
...
function datosAModificar() {
    ...
    if (tipo == 'paciente' || tipo == 'enfermera') {
        fetch ('http://34.69.253.122:5000/modificarperfil', {
            method: 'POST',
            headers: headers,
            body: `{
                "nombre de usuario":"${user}"
        ...
        fetch('http://34.69.253.122:5000/modificar-medicamento', {
            method: 'POST',
            headers: headers,
            body: `{
                "nombre":"${user}"
...
function modificarUsuario() {
    ...
    if (tipo == 'paciente' || tipo == 'enfermera') {
        if (nombre == " " || apellido == " " || nacimiento == " " || usuario == " " || password == " ") {
            ...
            fetch('http://34.69.253.122:5000/modificar', {
                method: 'POST',
                headers: headers,
                body: `{
                    "usuario":"${user}",
...
function modificarMedicamento() {
    ...
    fetch('http://34.69.253.122:5000/modificar-medicamento/modificar', {
        method: 'POST',
        headers: headers,
        body: `{
...
function cita() {
    ...
    console.log(user)
    window.location.replace("http://34.69.253.122:5000/solicitar-cita")
}
...
function solicitarCita() {
    ...
    fetch ('http://34.69.253.122:5000/solicitar-cita', {
        method: 'POST',
        headers: headers,
        body: `{
            "id":" ",
...
function cargarCitas() {
    ...
    fetch('http://34.69.253.122:5000/ver-citas', {
        method: 'POST',
        headers: headers,
        body: `{
            "nombre de usuario":"${user}"
...
function irACarrito() {
    window.location.replace("http://34.69.253.122:5000/carrito")
}
...
function comprar() {
    ...
    fetch('http://34.69.253.122:5000/comprar', {
        method: 'POST',
        headers: headers,
        body: `{
...
function irACitas(tipo) {
    if (tipo == 'enfermera') {
        localStorage.setItem('tipo', tipo)
        window.location.replace('http://34.69.253.122:5000/administrar-citas')
    } else if (tipo == 'doctor') {
        localStorage.setItem('tipo', tipo)
        window.location.replace('http://34.69.253.122:5000/administrar-citas')
    }
...
function cerrarSesion() {
    localStorage.clear()
    window.location.replace('http://34.69.253.122:5000/login')
}
